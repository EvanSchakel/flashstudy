...
## 2024-06-05 - Use Specific Feedback Messages in CLI apps
**Learning:** For CLI applications, generic feedback statements (like "Deck created" or "Card added") lack context and do not clearly reassure users that their specific action was successful. Using specific identifiers improves clarity.
**Action:** Always include the specific entity's name or a strong identifier (e.g., "Deck 'Math' created", "Card added to deck 'Math'") in success or error feedback messages.
