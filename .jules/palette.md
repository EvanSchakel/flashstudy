...
## 2024-06-25 - Contextual Entity Names in CLI Feedback
**Learning:** Generic feedback messages like "Deck created" or "Deleted" lack context and can leave users uncertain if their action applied to the intended target. Including the specific entity name reassures users that their intended action was successful on the correct target.
**Action:** Always include the specific entity's name (e.g., "Deck 'Math' created") or a strong identifier in success or error feedback messages rather than generic statements.
