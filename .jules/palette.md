...
## 2024-06-04 - Specific Entity Names in CLI Feedback
**Learning:** For CLI applications, generic feedback statements (like "Deck created" or "Deleted") leave users uncertain if the action succeeded on the intended target, increasing cognitive load and uncertainty. Providing specific entity identifiers in success/error messages provides essential reassurance.
**Action:** Always include the specific entity's name or a strong identifier (e.g., "Deck 'Math' created") in success or error feedback messages rather than generic statements.
