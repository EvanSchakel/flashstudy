...
## 2024-05-31 - Include Entity Identifiers in CLI Feedback
**Learning:** Generic feedback messages (like "Deck created" or "Deleted") leave users uncertain about whether the correct entity was acted upon, especially in CLI apps where context can quickly scroll out of view.
**Action:** Always include the specific entity's name or a strong identifier in success or error feedback messages to provide better context and reassure users.
