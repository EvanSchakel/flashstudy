...
## 2024-07-05 - Specific Entity Names in CLI Feedback
**Learning:** Generic feedback messages like "Deck created" or "Card added" lack context, forcing users to remember or verify which item was affected. Including specific entity names or strong identifiers directly in success or error messages reassures users and improves the overall intuitiveness of the interface.
**Action:** Always include the specific entity's name or a strong identifier (e.g., "Deck 'Math' created") in success or error feedback messages rather than relying on generic statements.
