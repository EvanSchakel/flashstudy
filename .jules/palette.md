...
## 2024-05-29 - Contextual Feedback Messages
**Learning:** Generic success/error messages in CLI applications (e.g., "Deck created") lack context, forcing users to rely on working memory to confirm which entity was operated on.
**Action:** Always include the specific entity's name (e.g., "Deck 'Math' created") in success or error feedback messages to improve cognitive accessibility and reassure users.
