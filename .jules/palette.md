...
## 2024-07-07 - Contextual Feedback for CLI Actions
**Learning:** Generic success/error messages (like "Deck created.") lack context and can leave users unsure if the intended action applied to the correct item. Including specific entity names provides reassurance and better context.
**Action:** For CLI applications, always include the specific entity's name or a strong identifier in success or error feedback messages rather than generic statements.
