...
## 2024-06-23 - Specific Entity Names in CLI Feedback
**Learning:** Generic success/error messages (like "Deck created" or "Deleted") leave users uncertain about whether the application performed the action on the intended item, especially in CLI environments where visual context is minimal.
