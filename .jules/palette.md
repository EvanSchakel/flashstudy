...
## 2024-06-02 - Include Specific Entity Names in CLI Feedback
**Learning:** Generic feedback messages like 'Deck created' or 'Deleted' lack context, especially in CLI applications where visual state is not persistent. Users may forget which entity they just created or deleted.
**Action:** Always include the specific entity's name or a strong identifier (e.g., 'Deck Math created') in success or error feedback messages to reassure users the intended action was successful.
