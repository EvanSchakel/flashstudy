...
## 2024-06-24 - Provide Explicit Entity Names in CLI Feedback
**Learning:** Generic CLI feedback messages like "Deck created" or "Deleted" lack context and can leave users unsure if their intended action was successful on the correct item.
**Action:** For CLI applications, always include the specific entity's name or a strong identifier (e.g., "Deck 'Math' created") in success or error feedback messages to provide better context and reassure users.
