...
## 2026-06-17 - CLI Feedback Specificity
**Learning:** For CLI applications, generic feedback like "Deck created" lacks context. Including the specific entity's name (e.g., "Deck 'Math' created") provides better context and reassures users.
