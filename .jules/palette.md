...
## 2026-06-01 - Include entity names in CLI feedback
**Learning:** Generic feedback messages in CLI applications (like "Deck created.") provide poor context, especially when managing multiple entities. Users may be unsure if their intended action succeeded.
