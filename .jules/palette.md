...
## 2026-06-12 - Provide Explicit Context in CLI Feedback Messages
**Learning:** Generic success or error messages (e.g., 'Deck created' or 'Deleted.') in CLI applications lack context and can leave users uncertain if the intended action occurred on the correct entity.
