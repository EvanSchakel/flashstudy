...
## 2026-05-30 - Conditional File Saves
**Learning:** Blindly executing save operations after an interactive session, regardless of whether the user actually modified the entity, causes unnecessary disk I/O and cache invalidations, especially if the user quits early.
**Action:** Track state modifications during interactive sessions and use early returns to conditionally skip save operations if the entity is unmodified, avoiding redundant disk I/O.
