...
## 2026-07-05 - Avoid Unnecessary Saves During Interactive Sessions
**Learning:** In interactive CLI applications, users often enter a view (like a study session) and immediately quit without modifying anything. Blindly saving state on exit causes redundant disk I/O and object serialization.
