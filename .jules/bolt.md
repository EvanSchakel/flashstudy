...
## 2026-06-17 - Avoid disk I/O on unattempted study sessions
**Learning:** By default, study sessions trigger a disk save even if the user quits without attempting any cards.
**Action:** Track interaction state and use early returns to conditionally bypass `saveDeck()`, eliminating unnecessary disk writes on zero-interaction sessions.
