...
## 2026-06-13 - Conditional Save on State Modification
**Learning:** Writing data to disk when an interactive operation has been immediately aborted (e.g., studying 0 cards) introduces unnecessary I/O overhead since the underlying state remains unchanged.
