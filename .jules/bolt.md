...
## 2026-06-09 - Prevent Unnecessary Disk I/O on Unmodified State
**Learning:** Saving the state of an entity back to disk unconditionally after a user session (like a study session) incurs unnecessary disk I/O overhead if the user exited early without making any modifications.
