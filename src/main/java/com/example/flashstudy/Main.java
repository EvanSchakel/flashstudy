...
public class Main {
    ...
    private static void logError(Throwable t) {
        try {
            ...
            try {
                // 🛡️ Sentinel: Create directory with strict POSIX permissions atomically
            ...
            try {
                // 🛡️ Sentinel: Create file with strict POSIX permissions atomically
            ...
            // 🛡️ Sentinel: Prevent Symlink Race (TOCTOU) by using NOFOLLOW_LINKS
            try (java.io.Writer fw = new java.io.OutputStreamWriter(Files.newOutputStream(errorLogPath, java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND, java.nio.file.StandardOpenOption.WRITE, java.nio.file.LinkOption.NOFOLLOW_LINKS), java.nio.charset.StandardCharsets.UTF_8);
