...
public class Main {
    ...
    private static void studyDeck() throws Exception {
        ...
        // ⚡ Bolt Optimization: Skip saving the deck to disk if no cards were attempted.
        // Impact: Eliminates redundant disk I/O overhead when exiting a study session early.
