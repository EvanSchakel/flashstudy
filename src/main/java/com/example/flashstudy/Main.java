...
public class Main {
    ...
    private static void studyDeck() throws Exception {
        ...
        // ⚡ Bolt Optimization: Only save the deck if cards were actually attempted and modified during the session.
        // Impact: Eliminates unnecessary disk I/O when users exit a study session without making any changes.
