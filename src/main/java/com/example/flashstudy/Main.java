...
public class Main {
    ...
    private static void logError(Throwable t) {
        try {
            ...
            // 🛡️ Sentinel: Enforce strict file permissions for the error log file to prevent info leakage and fix TOCTOU symlink attack
            try {
            ...
            try (java.io.OutputStream os = Files.newOutputStream(errorLogPath, java.nio.file.LinkOption.NOFOLLOW_LINKS, java.nio.file.StandardOpenOption.CREATE, java.nio.file.StandardOpenOption.APPEND, java.nio.file.StandardOpenOption.WRITE);
                 java.io.Writer fw = new java.io.OutputStreamWriter(os, java.nio.charset.StandardCharsets.UTF_8);
