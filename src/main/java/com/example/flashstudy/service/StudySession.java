...
public class StudySession {
    ...
    // ⚡ Bolt Optimization: Return the number of attempted cards to track state modification.
    // Impact: Allows caller to skip disk I/O if the session state is completely unmodified.
